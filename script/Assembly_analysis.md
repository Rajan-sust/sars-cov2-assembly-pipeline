...
c = read_tsv("~/Gdrive_tutorial_edits/Assembly_COVID19/data/SraRunTable_COVID19_14.06.20.txt")
...
```r
#
#write_csv(c2, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/COVID19_14.06.20_metadata_final.csv")
...
```r
#write_tsv(df, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/summary_data.tsv")
...
#write_csv(ab_pe, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/PE_561samples_final.csv")
#write_csv(ab_se, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/SE_300samples_final.csv")
#write.table(ab_pe$Run, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/PE_561samples_final_561runs.txt", col.names = F, row.names = F, quote = F)
#write.table(ab_se$Run, "~/Gdrive_tutorial_edits/Assembly_COVID19/data/SE_300samples_final_300runs.txt", col.names = F, row.names = F, quote = F)
